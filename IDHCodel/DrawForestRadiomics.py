...
for  i in range(2):
    ...
    for j in range(20):
        ...
        X_features_train1, X_features_test1, w1, pred1 = rf_dis(n_trees=ntrees, X=Xnew1, Y=Y, train_indices=train_in,
    ...
    tr.append(ntrees)
print(err1,err2,err3,tr)
pl.xlabel('tree number')
data.append(err1,err2,err3,tr)
...
prediction = pandas.DataFrame(data).to_csv('IDHCV1.csv')
