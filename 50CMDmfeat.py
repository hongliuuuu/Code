...
def mcode(ite):
    if ite ==0:
        file = "50newCMDallMfeat6"
        dataX = Mfeat6
        dataY = MfeatY
    if ite ==1:
        file = "50newCMDallMfeat2"
        dataX = Mfeat2
        dataY = MfeatY
    if ite == 2:
        file = "50newCMDallMfeat3"
        dataX = Mfeat3
        dataY = MfeatY
    if ite ==3:
        file = "50newCMDallMfeat4"
        dataX = Mfeat4
        dataY = MfeatY
    if ite == 4:
        file = "50newCMDallMfeat5"
        dataX = Mfeat5
        dataY = MfeatY
    if ite == 5:
        file = "50newCMDallBBC1"
        dataX = BBC1
        dataY = BBCY
    if ite == 6:
        file = "50newCMDallBBC2"
        dataX = BBC2
        dataY = BBCY
...
if __name__ == '__main__':
    Parallel(n_jobs=10)(delayed(mcode)(ite=i) for i in range(7))
'''
