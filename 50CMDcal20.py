...
def mcode(ite):
    if ite == 0:
        file = "50newCMDallCal201"
        dataX = Cal201
        dataY = Cal20Y
    if ite == 1:
        file = "50newCMDallCal202"
        dataX = Cal202
        dataY = Cal20Y
    if ite == 2:
        file = "50newCMDallCal203"
        dataX = Cal203
        dataY = Cal20Y
    if ite == 3:
        file = "50newCMDallCal204"
        dataX = Cal204
        dataY = Cal20Y
    if ite == 4:
        file = "50newCMDallCal205"
        dataX = Cal205
        dataY = Cal20Y
    if ite == 5:
        file = "50newCMDallCal206"
        dataX = Cal206
        dataY = Cal20Y
...
if __name__ == '__main__':
    Parallel(n_jobs=10)(delayed(mcode)(ite=i) for i in range(6))
'''
